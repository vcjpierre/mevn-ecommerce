            ...
            <div class="spc-orders a-box">
              <div class="a-box-inner">
                <div class="shipping-group">
                  <!-- Estimated delivery -->
                  <div class="a-row a-color-state a-text-bold a-size-medium a-spacing-small">
                  ...
                  <div class="a-row">
                    ...
                    <div class="order-summary" style="font-size: 12px;">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-right">USD {{ formatPrice(getCartTotalPriceWithShipping) }}</div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-6 text-right">
                          ...
                          <div class="a-color-price a-size-medium a-text-bold">
                            USD {{ formatPrice(getCartTotalPriceWithShipping) }}
                          </div>
                        </div>
                      </div>
                    </div>
